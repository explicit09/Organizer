...
extension Color {
    ...
    static let areaWork = Color.blue
    static let areaPersonal = Color.green
    static let areaHealth = Color.red
    static let areaLearning = Color.purple
    static let areaFinance = Color.orange
}
